...
class Activity extends Component {
    ...
    constructor(props) {
        ...
        let inputList = ["red", "pink", "blue", "green", "black"]
            ...
            <div className='container w-full h-screen pt-14 p-4'>
                <div className='inner-container w-full h-full'>
                    ...
                    {this.state.activity.map((pointItem, index) => (
                        <div className='cpvl-points flex items-start ml-3 w-3/5 h-auto cursor-pointer ' key={index} style={{ minHeight: "4.5rem" }}>

                            <div className={`flex flex-col ${index <= this.state.pointColor.length - 1 ? "justify-start" : "justify-center"} items-center mr-4`} style={{ minHeight: "4.5rem", height: "max-containt" }}>
                                ...
                                {index <= this.state.pointColor.length - 2 &&
                                    <div style={{ border: "0.5px solid rgba(0,0,0,0.2)", minHeight: "4.9rem" }}></div>}
                            </div>

                            <div className='flex flex-col rounded-lg items-start -mt-4 mb-1 hover:shadow-xl p-3 hover:bg-white' style={{ minHeight: "4rem" }}>
